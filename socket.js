...
teacherNSP.on('connection', function(teacher){
	...
	teacher.on('new message', function(data){
		studentNSP.to(teacher.currentRoom).emit('new message', data);
	});
...
studentNSP.on('connection', function(student){
	...
	student.on('new message', function(data){
		teacherNSP.to(student.currentRoom).emit('new message', data);
		studentNSP.to(student.currentRoom).emit('new message', data);
	});
